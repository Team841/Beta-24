...
public class Swerve {
  ...
  private static final Slot0Configs steerGains = new Slot0Configs().withKP(0.047885).withKI(0).withKD(0.0037064).withKS(0.16882).withKV(2.7672).withKA(0.063674);
  ...
  private static final double kSlipCurrentA = 250.0; // 300
  ...
  private static final double kFrontLeftEncoderOffset = -0.42138671875;
  ...
  private static final double kFrontRightEncoderOffset = -0.476318359375;
  ...
  private static final double kBackLeftEncoderOffset = 0.427734375;
  ...
  private static final double kBackRightEncoderOffset = -0.029052734375;
